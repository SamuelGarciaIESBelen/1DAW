...
CREATE TABLE gama_producto (
  ...
  descripcion_texto VARCHAR(1024),
  descripcion_html VARCHAR(1024),
  imagen VARCHAR(256)
);
...
ALTER TABLE empleado ADD CONSTRAINT FOREIGN KEY (codigo_oficina) REFERENCES oficina (codigo_oficina),
                     ADD CONSTRAINT FOREIGN KEY (codigo_jefe) REFERENCES empleado (codigo_empleado);

ALTER TABLE cliente ADD CONSTRAINT FOREIGN KEY (codigo_empleado_rep_ventas) REFERENCES empleado (codigo_empleado);

ALTER TABLE pedido ADD CONSTRAINT FOREIGN KEY (codigo_cliente) REFERENCES cliente (codigo_cliente);

ALTER TABLE producto ADD CONSTRAINT FOREIGN KEY (gama) REFERENCES gama_producto (gama);

ALTER TABLE detalle_pedido ADD CONSTRAINT FOREIGN KEY (codigo_pedido) REFERENCES pedido (codigo_pedido),
                           ADD CONSTRAINT FOREIGN KEY (codigo_producto) REFERENCES producto (codigo_producto);

ALTER TABLE pago ADD CONSTRAINT FOREIGN KEY (codigo_cliente) REFERENCES cliente (codigo_cliente);
